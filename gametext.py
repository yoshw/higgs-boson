...
dic["entryrm"][door] = copy.deepcopy(dic["entryrm"][roomd])
...
You look around. Along the curved wall, opposite the front doors, is another, smaller steel door. The only other object in the room is a plush armchair a few metres away from you. Carl Sagan is sitting in the armchair, calmly reading a book. He looks up.
...
dic["entryrm"][roomd][1]["look"] = "print w('You are in a small, gravityless spherical chamber. On the west side, the front doors of the Standard Model Dungeon. On the east, a large steel door. Carl Sagan floats in an armchair nearby.')"
...
dic["entryrm"][chair][0]["look"] = dic["entryrm"][chair][0]["talk"] = dic["entryrm"][chair][0]["open"] = dic["entryrm"][chair][0]["use"] = dic["entryrm"][chair][0]["take"] = "print w('The chair has vanished.')"

dic["entryrm"][door][0]["look"] = dic["entryrm"][door][0]["talk"] = dic["entryrm"][door][0]["open"] = dic["entryrm"][door][0]["use"] = dic["entryrm"][door][0]["take"] = "print w('The door has vanished.')"

dic["entryrm"][sagan][0]["look"] = dic["entryrm"][sagan][0]["talk"] = dic["entryrm"][sagan][0]["open"] = dic["entryrm"][sagan][0]["use"] = dic["entryrm"][sagan][0]["take"] = "print w('Sagan has vanished.')"


dic["entryrm"][chair][1] = {
    "look": "print w('A high-backed red velour armchair.')",
    "talk": "print w('You talk to chairs? Like, regularly?')",
    "open": "print w('''You don't have anything to open it with.''')",
    "use" : "print w('''Sagan's already using it.''')",
    "take": "print w('''I'm afraid you can't do that.''')"
    }
...
dic["entryrm"][door][1] = {
    ...
    "open": """print w('You try the handle on the heavy steel door. It is unlocked, and opens slowly.')
room('mainrm')""",
    "use" : "print w('Try opening it instead.')",
    "take": "print w('''Hey, you can't do that.''')"
    }
dic["entryrm"][door][1]["use"] = copy.deepcopy(dic["entryrm"][door][1]["open"])
dic["entryrm"][door][2] = copy.deepcopy(dic["entryrm"][door][1])
dic["entryrm"][door][3] = copy.deepcopy(dic["entryrm"][door][1])
dic["entryrm"][door][3]["look"] = "print w('''Don't just look at it, go through the damn thing!''')"


dic["entryrm"][sagan][1] = {
    "look": "print w('Carl Sagan: astrophysicist, science communicator, gentleman. Dressed in corduroy. A wry smile plays on his face.')",
    "talk": "print w('''Sagan smiles benevolently. 'No point talking to me, friend. I don't have the boson. I suggest you try going through this door. Seems the logical thing to do.' ''')",
    "open": "print w('''That's just rude.''')",
    "use" : "print w('''You can't do that.''')",
    "take": "print w('You think you could take Carl Sagan? Think again.')"
    }
dic["entryrm"][sagan][2] = copy.deepcopy(dic["entryrm"][sagan][1])
dic["entryrm"][sagan][3] = copy.deepcopy(dic["entryrm"][sagan][1])
dic["entryrm"][sagan][3]["look"] = "print w('Sagan bounces up and down, pointing at the door, muttering excitedly.')"
dic["entryrm"][sagan][3]["talk"] = "Sagan is too excited to talk. He bounces up and down, pointing at the door."
...
dic["mainrm"][e_door][1] = {
    ...
    "talk": "print w('The door remains silent.')",
    "open": "print w('There is a very complicated lock on it! More info to come.')",
    "take": "print w('''Hey, you can't do that.''')"
    }
dic["mainrm"][e_door][1]["use"] = copy.deepcopy(dic["mainrm"][e_door][1]["open"])

dic["mainrm"][s_door][1] = {
    "look": "print w('A black door with a round handle, set in the south wall.')",
    "talk": "print w('The door remains silent.')",
    "open": """print w('The door opens easily, and you pass through.')
room('muneurm')""",
    "take": "print w('''Hey, you can't do that.''')"
    }
dic["mainrm"][s_door][1]["use"] = copy.deepcopy(dic["mainrm"][s_door][1]["open"])
...
dic["mainrm"][n_door][1] = {
    ...
    "talk": "print w('The door remains silent.')",
    "open": """print w('The handle turns easily, and you pass through the door.')
room('strangerm')""",
    "take": "print w('''Hey, you can't do that.''')"
    }
dic["mainrm"][n_door][1]["use"] = copy.deepcopy(dic["mainrm"][n_door][1]["open"])

dic["mainrm"][w_door][1] = {
    "look": "print w('''The steel door you just came through. You can go back if you like, but I wouldn't recommend it.''')",
    "talk": "print w('The door remains silent.')",
    "open": """print w('With an effort, you push open the door and go back to the entrance chamber.')
room('entryrm')""",
    "take": "print w('''Hey, you can't do that.''')"
    }
dic["mainrm"][w_door][1]["use"] = copy.deepcopy(dic["mainrm"][w_door][1]["open"])

"""dic["mainrm"][staircase][1] = {
    "look": "print w('A spiral staircase. It must have hundreds of steps.')",
    "talk": "print w('That will not work.')",
    "open" : "print w('Try using it instead.')",
...
dic["strangerm"][roomd][0]["look"] = """print w('''You close the door behind you quietly. You are in a small room with identical, featureless doors to the west, north and east. In the centre of the room, a thin man with a moustache paces back and forth, muttering to himself. You recognise him as Paul Dirac.
...
dic["strangerm"][n_door][1] = {
    ...
    "talk": "print w('The door remains silent.')",
    "open": """print w('''As you go to open the door, Dirac quietly intercepts you and pushes you back.

'Tut tut,' he says, not looking you directly in the eyes. 'Not yet.' ''')""",
    "take": "print w('''Hey, you can't do that.''')"
    }
dic["strangerm"][n_door][1]["use"] = copy.deepcopy(dic["strangerm"][n_door][1]["open"])
...
dic["strangerm"][e_door][1]["use"] = copy.deepcopy(dic["strangerm"][e_door][1]["open"])

dic["strangerm"][s_door][1] = {
    "look": "print w('The door you just came through.')",
    "talk": "print w('The door remains silent.')",
    "open": """print w('With an effort, you push open the door and go back to the central room.')
room('mainrm')""",
    "take": "print w('''Hey, you can't do that.''')"
    }
dic["strangerm"][s_door][1]["use"] = copy.deepcopy(dic["strangerm"][s_door][1]["open"])

dic["strangerm"][w_door][1] = {
    "look": "print w('A featureless door.')",
    "talk": "print w('The door remains silent.')",
    "open": """print w('''As you open the door, you notice Dirac watching you. He seems to be smiling.''')
room('downrm')""",
    "take": "print w('''Hey, you can't do that.''')"
    }
dic["strangerm"][w_door][1]["use"] = copy.deepcopy(dic["strangerm"][w_door][1]["open"])

dic["strangerm"][dirac][1] = {
    "look": "print w('Paul Dirac: a thin, strange English physicist who predicted the existence of antimatter.')",
...
You decide not to bother him further.''')""",
    ...
    "take": "print w('''Now's not the time to be picking fights with geniuses.''')"
    }
...
states["downrm"][portal] = 2""",
    ...
    "take": "print w('''Where would you put him? He sure won't fit in your shoulder bag.''')"
    }
...
dic["downrm"][e_door][1] = {
    "look": "print w('The door you just came through.')",
    "talk": "print w('The door remains silent.')",
    "open": """print w('With an effort, you push open the door and go back.')
room('strangerm')""",
    "take": "print w('''Hey, you can't do that.''')"
    }
dic["downrm"][e_door][1]["use"] = copy.deepcopy(dic["downrm"][e_door][1]["open"])

dic["downrm"][n_door][1] = {
    "look": dic["downrm"][gellmann][1]["talk"],
    "talk": "print w('The portal is silent.')",
    "open": dic["downrm"][gellmann][1]["talk"],
    "take": "print w('''Hey, you can't do that.''')"
    }
dic["downrm"][n_door][1]["use"] = copy.deepcopy(dic["downrm"][n_door][1]["open"])
...
dic["downrm"][n_door][2]["open"] = dic["downrm"][n_door][2]["use"] = """print w('You stoop and pass through the portal.')
room('uprm')"""
...
dic["downrm"][wardrobe][1] = {
    ...
    "open": """print w('You swing open the old doors of the wardrobe. The inside smells of mothballs and old paint. There are no clothes in here, just an old tripod, a coil of rope, and what appears to be a silver teaspoon.')
...
dic["downrm"][wardrobe][2]["open"] = dic["downrm"][wardrobe][2]["use"] = "print w('You already opened it.')"
...
dic["downrm"][rope][1] = {
    ...
    "talk": "print w('''It's not saying anything right now.''')",
    "open": "print w('That makes no sense.')",
    "use" : "print w('''You can't use it here.''')",
    "take": """print w('You brush the cobwebs off the rope and stuff it into your bag.')
states['downrm'][rope] = 2
states['inv'][rope] = 1
states['downrm'][wardrobe] = 3"""
    }
dic["downrm"][rope][2]["look"] = dic["downrm"][rope][2]["talk"] = dic["downrm"][rope][2]["open"] = dic["downrm"][rope][2]["use"] = dic["downrm"][rope][2]["take"] = "print w('The rope is gone. You took it.')"
...
states['uprm'][roomd] = 2
states['uprm'][rope] = 0"""
dic["downrm"][rope][3]["take"] = "print w('''You can't take it.''')"
dic["downrm"][rope][4] = {}
dic["downrm"][rope][4]["look"] = dic["downrm"][rope][4]["talk"] = dic["downrm"][rope][4]["open"] = dic["downrm"][rope][4]["use"] = dic["downrm"][rope][4]["take"] = "print w('''You've done all you can with the rope.''')"

dic["downrm"][tripod][0] = {}
dic["downrm"][tripod][1] = {
    "look": "print w('A rusty old three-legged camera stand.')",
    "talk": "print w('''It's not saying anything right now.''')",
    "open": "print w('You work the stiff legs of the tripod back and forth -- to little effect.')",
    "use" : "print w('''What are you going to use it for? You don't have anything to rest on it.''')",
    "take": """print w('You fold up the tripod and stuff it into your bag. It pokes you when you walk.')
states['downrm'][tripod] = 2
states['inv'][tripod] = 1
states['downrm'][wardrobe] = 3"""
    }
dic["downrm"][tripod][2]["look"] = dic["downrm"][tripod][2]["talk"] = dic["downrm"][tripod][2]["open"] = dic["downrm"][tripod][2]["use"] = dic["downrm"][tripod][2]["take"] = "print w('The tripod is gone. You took it.')"

dic["downrm"][teaspoon][0] = {}
dic["downrm"][teaspoon][1] = {
    "look": "print w('A silver teaspoon.')",
    "talk": "print w('''It's not saying anything right now.''')",
    "open": "print w('''It doesn't open.''')",
    "use" : "print w('''You can't use it here.''')",
    "take": """print w('You pick up the spoon and stuff it in your bag.')
states['downrm'][teaspoon] = 2
states['inv'][teaspoon] = 1
states['downrm'][wardrobe] = 3"""
    }
dic["downrm"][teaspoon][2]["look"] = dic["downrm"][teaspoon][2]["talk"] = dic["downrm"][teaspoon][2]["open"] = dic["downrm"][teaspoon][2]["use"] = dic["downrm"][teaspoon][2]["take"] = "print w('The teaspoon is gone. You took it.')"
...
dic["downrm"][hadrons][1] = {
    ...
    "talk": "print w('''It's not saying anything right now.''')",
    "open": "print w('''Gell-Mann is using it right now.''')",
    "use" : "print w('''Gell-Mann is using it right now.''')",
    "take": "print w('''Gell-Mann is using it right now.''')",
    }
...
dic["uprm"][hadrons][1] = {
    ...
    "talk": "print w('''It's not saying anything right now.''')",
    "open": "print w('''Better not. Powerful forces are at work inside. Only Gell-Mann can master the hadrons.''')",
    "use" : "print w('''Better not. Powerful forces are at work inside. Only Gell-Mann can master the hadrons.''')",
    "take": """print w('''You try to pick up the case, but you find it to be surprisingly heavy. You can drag it, slowly, but there's no way you can carry it back through the portal.''')"""
    }
...
dic["uprm"][s_door][1] = {
    ...
    "talk": "print w('The portal is silent.')",
    "open": """print w('You jump up, grab the lintel, and pull yourself through the portal.')
room('downrm')""",
    "take": "print w('''Hey, you can't do that.''')"
    }
dic["uprm"][s_door][1]["use"] = copy.deepcopy(dic["uprm"][s_door][1]["open"])
...
dic["uprm"][rope][1] = {
    ...
    "take": "print w('''That's not a good idea.''')"
    }
...
'Hello there, bud,' he says. 'You think you're gettin' into the next room? Think again. Not as long as I'm around.' He folds his arm and grins EVEN WIDER.''')""",
    ...
    "take": "print w('''Sure, he's a skinny guy, but he's wily. Don't underestimate his strength.''')"
    }
...
dic["muneurm"][n_door][1]["use"] = copy.deepcopy(dic["muneurm"][n_door][1]["open"])
    
dic["muneurm"][s_door][1] = {
    "look": "print w('Another mysterious door. Who knows where this one leads?')",
    "talk": "print w('The door remains silent.')",
    "open": """print w('''You walk over to the door and reach for the handle, but suddenly Feynman comes from nowhere and pushes you backwards, hard.

'Where do you think you're going, buddy?' he says. 'What a load of guff.' He sits back down.''')""",
    "take": "print w('''Hey, you can't do that.''')"
    }
dic["muneurm"][s_door][1]["use"] = copy.deepcopy(dic["muneurm"][s_door][1]["open"])
dic["muneurm"][s_door][2] = copy.deepcopy(dic["muneurm"][s_door][1])
dic["muneurm"][s_door][2]["open"] = dic["muneurm"][s_door][2]["use"] = """print w('With Feynman safely distracted, you open the door easily and pass into the next room.')
room('entryrm')"""
